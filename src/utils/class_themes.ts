...
export const bgSports = [
  "img_wrestling",
  "img_volleyball",
  "img_athleticsjumping",
  "img_americanfootball",
  "img_triathlon",
  "img_rowing",
  "img_equestrian",
  "img_waterpolo",
